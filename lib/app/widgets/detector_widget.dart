...
import 'package:isibi/app/models/recognition.dart';
import 'package:isibi/app/models/screen_params.dart';
import 'package:isibi/app/service/detector_service.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Text(
          results.toString(),
          style: regular.copyWith(fontSize: 15, color: Colors.black),
        ),
      ],
    );
  }
